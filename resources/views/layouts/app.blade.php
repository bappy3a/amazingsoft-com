...
<head>
    ...
    <!--bappy-shop Stylesheet [ REQUIRED ]-->
    <link href="{{ asset('css/bappy-shop.min.css')}}" rel="stylesheet">

    <!--bappy-shop Premium Icon [ DEMONSTRATION ]-->
    <link href="{{ asset('css/demo/bappy-shop-demo-icons.min.css')}}" rel="stylesheet">
    ...
    <!--bappy-shop [ RECOMMENDED ]-->
    <script src="{{ asset('js/bappy-shop.min.js') }}"></script>
...
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-143305229-1"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'UA-143305229-1');
</script>
